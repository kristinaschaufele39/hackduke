...
file_names = ["melville.txt", "trump.txt", "twain.txt"]
files_compiled = [];
...
nearest_words = [files_compiled[i] for i in neighbor_indices]

# Print the nearest neighbors and their distances
for file, distance in zip(nearest_words, neighbor_distances):
    print(f'File: {file_name}, Similarity Score: {1 - distance}')